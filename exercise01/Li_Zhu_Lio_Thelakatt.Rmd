...
We ran a kmeans++ model using k=4, k=5, and k=6. Below you can see the outputs for each one. It turns out the using K=6 gave us too many clusters that didn't have very significant differences between them and that k=4 was not showing all the possible market segmentations, so for our final model we picked k=5.
```{r, echo=TRUE}
...
clust6$betweenss
```
Usin k=5, we found the following clusters to represent the following market segments:

1. Cluster 1
- Focused around people who mentioned college universiteis, online gaming, and sports the most. We figure that this is proabably a customer segmentation of young males from the ages of 16-22.

2. Cluster 2
- Focused around people who mentioned shopping, health nutrition, and news seldomly. We deemed this to possibly be young female adults, who use media sometimes, since their counts were low for these categories, but had even lower counts across the board.

3. Cluster 3
- Focused around people who talked a lot about cooking, fashion and beauty. We presume that this customer segment focuses on younger women aged 16-26 who uses social media a lot as their counts were pretty high for these areas.

4. Cluster 4
- Focused around those who mentioned food, family, parenting and religion a lot. This customer group seemed to be of an older age, and who had families with children. These would probably be adults aged 28-50.

5. Cluster 5
- Focused around those who mentioned health nutrition and personal fitness a lot. We deemed this cluster to be a customer segment consisting of young adults or adults who are very into fitness and staying healthy. 

Below we plotted some of the key distinctions in every segment, so that you could see the different customer segments, for k=5. 
```{r, echo=TRUE}
