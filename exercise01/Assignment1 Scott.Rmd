...
Lastly, we tried to see if rent was higher for those buildings that had amenities, and then factored in whether they were green certified or not.
```{r, echo=TRUE}
...
```
Amenities do not seem to affect RENT.
#### Conclusion
