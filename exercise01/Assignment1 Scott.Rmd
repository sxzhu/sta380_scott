...
On average both LEED and Energystar buildings have a higher leasing rate than buildings who are not leed or energystar certified. With the average being aorund 
```{r, echo=TRUE}
...
```
Whether or not either a Energystar certified building or a LEED certified building were renovated has no effect on the rent.
